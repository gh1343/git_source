$(document).ready(function(){
  $('.gnb').mouseenter(function(){
    ...
    $('.gnb>li').find('.sub').stop().slideUp(200);
    $('.sub_bg').hide();
  })
  $('.mb_icon').click(function(){
    $('.gnb,.sns,.sub_bg').toggleClass('on');
  ...
  //   if(scroll>900){
  //     $('.movie').animate({'margin-top':'0','opacity':'1'},1000,'linear')
  //   }
  //   if(scroll>1700){
  //     $('.play').animate({'margin-top':'0','opacity':'1'},1000,'linear')
  //   }
  //   if(scroll>2700){
  //     $('.maga1').animate({'margin-top':'0','opacity':'1'},1000,'linear')
  //   }
  //   if(scroll>3500){
  //     $('.maga2').animate({'margin-top':'0','opacity':'1'},1000,'linear')
  //   }
  // })
// movie
  // const $movie = $('.movie');
  //   $movie.find('.m_txt').stop().animate(
  //     {'transform':'translateY(0)','opacity':'1'},1000,'linear', function(){
  //       $movie.find('.m_list_wrap').stop().animate({'opacity':'1'},500)
  //     });
